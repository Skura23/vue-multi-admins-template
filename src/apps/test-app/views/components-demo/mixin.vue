...
<script>
import PanThumb from '@test/components/PanThumb'
import MdInput from '@test/components/MDinput'
import Mallki from '@test/components/TextHoverEffect/Mallki'
import DropdownMenu from '@test/components/Share/DropdownMenu'
import waves from '@test/directive/waves/index.js' // 水波纹指令
